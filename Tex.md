...
permits line breaks within the argument, respects current series (such as<br>
boldface), and works in both horizontal (text) and math mode.<br>
...
Use \mathid{...}, not $...$, to typeset a multi-character identifier in<br>
LaTeX math mode.  $...$ puts incorrect kerning between the letters.<br>
(It looks bad, and enough people will notice that it is worthwhile to get<br>
the typesetting right.)<br>
<br>
<a href='Hidden comment: 
% Can"t unindent the LaTeX comments or the doc program will respect those
% comments.  That"s unfortunate, because I typically unindent when inserting
